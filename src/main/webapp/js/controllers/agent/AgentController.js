function AgentController($scope, $location,$route,EmployeesService,UtilityService, $timeout,$state, $log,ngTableParams ,$rootScope,ngDialog) {
	...
	$scope.edit = false ;
	$scope.addArea = false;
	$scope.heading ="Makler hinzufügen";
	$scope.showAddArea = function(){
	   ...
	   $scope.save = function(){
		   ...
		   EmployeesService.create($scope.info).$promise.then(function (data) {
	             if (data != undefined && data != null)
	                 if (data.errorCode != undefined && data.errorCode != null)
	                 	...
	                 	UtilityService.notificationDilog("Makler erfolgreich hinzugefügt!");
	                 	$scope.resetForm(); 
	                 }
	    ...
	    $scope.detail= function(item){
	    	...
	    	$scope.edit =  true;
	    	$scope.addArea = true;
	    	$scope.heading ="Makler bearbeiten";
	    };
	    	...
	    	EmployeesService.update($scope.info).$promise.then(function (data) {
	             if (data != undefined && data != null)
	                 if (data.errorCode != undefined && data.errorCode != null)
	                 	...
	                 	UtilityService.notificationDilog("Makler erfolgreich geändert!");
	                 	$scope.resetForm(); 
	    	...
	    	EmployeesService.delete({id: id}).$promise.then(function (data) {
	            if (data != undefined && data != null)
	                if (data.errorCode != undefined && data.errorCode != null)
	                	...
	                	UtilityService.notificationDilog("Der ausgewählte Makler wurde gelöscht!");
    ...
    $scope.changePassword = function() {
    	EmployeesService.changePassEmployees($scope.passwordInput).$promise.then(function(data) {
        	...
        	$rootScope.error = "Das Makler konnte nicht gelöscht werden.";
            if (error.errorCode != undefined && error.errorCode != null)
                $rootScope.error = error.errorMessage;
        });
    }
