function CrawlersController($scope, $location,$route,CrawlersService,UtilityService, $timeout,$state, $log,ngTableParams ,$rootScope,ngDialog,$window,Upload) {
	...
	var fileToUpload = $scope.selectedFiles;	
	 ...
	 $("#importdataarea").css({"display":"none"});
    	$scope.upload = Upload.upload({
            url: 'rest/crawlerscdp4j/buildData', 
            method: 'POST',
            fields: {
